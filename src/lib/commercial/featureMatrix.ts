...
export const PRICING_PLANS = [
  {
    ...
    period: 'mãi',
    blurb:
      'Viết kịch bản + prompt + TTS cơ bản + gen ảnh BYOK — giới hạn 600 từ/chương, 2 chương, 3 lượt/ngày mỗi mục',
    highlights: [
      'Viết kịch bản ≤600 từ · ≤2 chương · 3 lượt/ngày',
      'Outline / Ideas · Gen Prompt · 3 lượt/ngày mỗi mục',
      'TTS Edge/Piper · Gen ảnh BYOK · 3 lượt/ngày mỗi mục',
      'Project portable',
    ],
  },
  {
