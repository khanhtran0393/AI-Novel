...
export const DOMAIN_OWNERSHIP: DomainOwnership[] = [
  ...
  {
    id: 'credentials',
    label: 'Keys / cookies / license / health',
    owns: [
      'workspace/features/settings',
      'workspace/features/license',
      'workspace/features/onboarding',
      'workspace/hooks/useEntitlementSync',
      'workspace/hooks/useProAccess',
